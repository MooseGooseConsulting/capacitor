...
| --- | --- |
| `schema/` drafts and wire mappings | Canonical identity, raw provenance, watermarks, PostgreSQL direction, fleet fields, and read-model questions in [Capture and data](capture-and-data.md), [Server interfaces](server-interfaces.md), and [Fleet and operations](fleet-and-operations.md). |
...
| Import/vendor observations and test plans | Fixture-first normalizer proof and remote PostgreSQL validation in [Capture and data](capture-and-data.md) and [Testing](testing.md). |
