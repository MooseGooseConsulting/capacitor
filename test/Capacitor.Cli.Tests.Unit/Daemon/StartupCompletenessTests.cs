...
// Connect) so the enriched DaemonConnect payload can advertise it. Reuses AgentOrchestratorHarness
// (BuildOrchestrator/CaptureServerConnection/SpyPtyProcessFactory).
public class StartupCompletenessTests {
    [Test]
