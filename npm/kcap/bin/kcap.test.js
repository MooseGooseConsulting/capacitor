...
assert.throws(() => resolveInstallSpec({ install_tag: "beta" }), /no npm update channel/);
assert.throws(() => resolveInstallSpec({}), /no npm update channel/);
assert.throws(() => resolveInstallSpec(null), /no npm update channel/);
