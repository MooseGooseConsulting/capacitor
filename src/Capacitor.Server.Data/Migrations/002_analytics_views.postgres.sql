...
-- Keep the PostgreSQL contract in lockstep with 002_analytics_views.sql. Dropping
-- the views first permits a prior recovery database to replace incompatible columns.
-- ============================================================================
...
SELECT
    ...
    (
        ...
        WHERE s2.repo_hash IS NOT DISTINCT FROM s.repo_hash AND s2.pr_number = s.pr_number
